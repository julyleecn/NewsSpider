...
//                baiduNewsService.CrawlBaiduNewsUrl("2017-11-1", "2017-11-2", new String[]{"同济大学软件学院", "华东师范大学软件学院"}, true);
                baiduNewsService.CrawlBaiduNewsUrl("2011-6-9", "2017-11-14", new String[]{"安徽 经济", "安徽 就业", "安徽 消费", "安徽 投资", "安徽 创新", "安徽 收入", "安徽 出口" }, true);
                break;
            case "sina":
                //搜索关键字、是否根据标题搜索
                sinaNewsService.CrawlSinaNewsUrl(new String[]{"同济大学"}, true);
                break;
            case "toutiao":
                //搜索关键字
